...
func newProducer(bc *conf.Bootstrap, logger log.Logger, textMapPropagator propagation.TextMapPropagator, tracerProvider trace.TracerProvider) (sarama.AsyncProducer, func(), error) {
